    ...
    <div class="wrapper fadeInDown">
        <div id="formContent"><br>
            ...
            <form action="/register" method="post">
                @csrf
                <input type="text" class="fadeIn first" name="Name" placeholder="Name">
                ...
                <input type="password" class="fadeIn first" name="Password_confirmation" placeholder="Password confirm"><br><br>
                <input type="submit" class="fadeIn first" value="Create Account">
            </form>
            <div id="formFooter">
                <a class="underlineHover" href="{{ route('RegAuth.auth') }}">Do you have an account?</a>
            </div>
        </div>
    </div>
</div>
