                ...
                <div class="w3ls_mobiles_grid_left_grid">
                    ...
                    <div class="w3ls_mobiles_grid_left_grid_sub">
                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                    <div class="panel-body panel_text">
                                        <ul>
                                            ...
                                            <li><a href="{{route('prod')}}">Wearables</a></li>
                                            <li><a href="{{route('prod2')}}">Refrigerator</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                    <div class="panel-body panel_text">
                                        <ul>
                                            <li><a href="{{route('prod2')}}">Grinder</a></li>
                                            <li><a href="{{route('prod2')}}">Heater</a></li>
                                            <li><a href="{{route('prod2')}}">Kid's Toys</a></li>
                                            <li><a href="{{route('prod2')}}">Filters</a></li>
                        ...
                        <ul class="panel_bottom">
                            <li><a href="{{route('prod')}}">Summer Store</a></li>
                            <li><a href="{{route('prod')}}">Featured Brands</a></li>
                            <li><a href="{{route('prod')}}">Today's Deals</a></li>
                            <li><a href="{{route('prod')}}">Latest Watches</a></li>
                        </ul>
                    </div>
                </div>
                <div class="w3ls_mobiles_grid_left_grid">
